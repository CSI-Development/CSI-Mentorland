...
function Navbar() {
  ...
  //   queryFn: ({ pageParam = 1 }) => getNotificationApi(pageParam),
  ...
  return (
    <header className="fixed z-50 flex h-[78px] w-full items-center justify-between border-b-[3px] border-[#2769D9] bg-white px-8 py-5">
      <div className="flex items-center gap-10">
        ...
        <div className="ml-4 flex w-72 items-center gap-10">
          ...
          >
            ...
            <Option value="course" className="flex items-center gap-2">
              <PiShootingStar className="text-xl" />
              Most Popular Course
            </Option>
            <Option value="setting" className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-4 text-3xl text-[#2769D9]">
        ...
        <div className="relative inline-block" ref={menuRef}>
          {menuVisible && (
            ...
            >
              ...
              {/* <InfiniteScroll
                dataLength={notificationData?.pages?.length ?? 0}
                next={fetchNextPage}
                hasMore={!!hasNextPage}
        ...
        <Image
          src={mentorData?.mentorAvatar ?? profile}
          alt="Profile"
          width={36}
          height={36}
        ...
        <div className="h-fit w-fit text-base" ref={supportRef}>
          {openSupportChat && <SupportChat data={mentorData} />}
        </div>
        <div className="text-base" ref={messageChatRef}>
          {openMessageChat && <MessageChat data={mentorData} />}
        </div>
