      ...
      <div className="h-screen pt-20">
        <div className="w-full h-full overflow-y-scroll ">
            ...
            <div className="relative">
              ...
              <div className="absolute left-40 top-1/3 w-1/3 pt-5 ">
                <p className="text-4xl font-bold">
                  LEARN WITH THE BEST, & GET PAID TO DO SO!
                </p>
                <Link href={"/signup"}>
          ...
          <div>
            ...
            />
            <button className="flex justify-center mt-2 mb-16 bg-[#2769d8] px-6 mx-auto py-2 text-lg rounded-lg">
              All Mentors
            </button>
          </div>
                ...
                return (
                  <div key={i} className="w-3/12 rounded-t-3xl bg-[#151B2B]">
                    ...
                    <div className="p-5  pt-0">
                      ...
                      <p className="text-lg text-[#FFD600] mt-1 mb-2">
                        {blog.date} - {blog.author}
                      </p>
                      <p className="text-lg">{blog.description}</p>
                      <button className="bg-[#2769d8] px-3 py-1 text-sm rounded-full mt-4">
                        Read More
                      </button>
                    </div>
                  </div>
          ...
          {/* section 7 */}
          <div
            className=" w-full mx-auto bg-cover bg-center pb-16 "
            style={{ backgroundImage: `url(${landingSection7.src})` }}
          >
            <p className="my-10 mt-16 text-3xl font-bold text-center">
