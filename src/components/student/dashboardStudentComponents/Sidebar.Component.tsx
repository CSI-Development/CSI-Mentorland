...
function Sidebar() {
  return (
    <div className=" h-full bg-[#fffefe] pt-24 border-r-2">

      <div className="flex text-black justify-start gap-2 px-8 py-2 mb-1 bg-slate-400">
        <Icon icon="mdi-light:view-dashboard" className="text-3xl" />
        <p className="text-lg my-auto">Dashboard</p>
      </div>

      <div className="flex text-black justify-start gap-2 px-8 py-2 mb-1 ">
