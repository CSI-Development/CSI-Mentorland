      ...
      <div className="w-full flex gap-6 justify-between">
        <div className="w-2/3 flex flex-col gap-6">
          <div className="w-full flex gap-6">
            ...
            <div className="flex flex-col gap-4">
              <h1 className="text-lg font-semibold">
                ...
                molestiae consequatur, dolores ratione autem odit eligendi
              </h1>
              <h2>
          ...
          <div>
            ...
            Praesentium facere veniam, aliquam, illo fugiat quasi ipsum tempora
            maiores perferendis cumque hic! Maxime harum quos tenetur unde eum a
            fuga, labore voluptates incidunt sit? Eligendi reprehenderit
            laudantium delectus quaerat error, velit corporis, itaque asperiores
            a ab maxime, excepturi beatae. Voluptates, voluptatibus
            necessitatibus!
          </div>
