        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 h-fit flex flex-col gap-3">
            ...
            <div className="text-sm font-thin text-[#5D6475] ">
              ...
              harum eius quae ipsa, natus animi tempore. Consequatur neque, nisi
              commodi facilis ab quia, temporibus quidem, libero odio incidunt
              iste qui. Iste neque quod a, qui magnam modi quibusdam repellat at
              aut! Numquam, aut nesciunt. Recusandae tenetur minima itaque
              dolorum esse molestiae ab maiores, fuga, aperiam quae totam, iusto
              quibusdam soluta.
            </div>
